...
# create dictionary
info = {
    'checkpoint': 'https://github.com/xiaoyanh/RKDapp/blob/main/dataset=RKDMuseum-net=ResNet50-lr=0p01-examples_per_class=None-num_classes=775-train_seed=0-forward_class=Classification-epoch=300.pth?raw=true',
    'net': 'ResNet50',
